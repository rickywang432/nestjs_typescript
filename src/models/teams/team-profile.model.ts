...
import { TeamMemberProfileNestedModel } from './team-member-profile-nested.model';
import { TeamType } from './team-type.enum';

/**
 * Contains information about a team.
 */
export class TeamProfileModel {
  /**
   * ID.
   */
  @ApiModelProperty({
   ...
   * Members.
   */
  @ApiModelProperty({ readOnly: true, description: 'Members.', type: TeamMemberProfileNestedModel, isArray: true })
  members: TeamMemberProfileNestedModel[];
